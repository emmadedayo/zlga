...
class PsColors {
  ...
  static Color mainColorSecondary;
  static Color mainColorTextField;
  static Color mainTextFieldColor;
  ...
  // Error Color
  static Color redColor, warningColor, infoColor;
  ...
  static const Color _c_main_color = Color(0xFF158f08);
  static const Color _c_main_secondary_color =  Color(0xFF056333);
  static const Color _c_main_color_text_field = Color(0xFFF6F8F9);
  static const Color _c_main_text_field_color = Color(0xFF666666);
  static const Color _c_main_light_color = Color(0xFFE7F4D7);
  static const Color _c_main_dark_color = Color(0xFF131B09);
  static const Color _c_main_yellow_color = Color(0xFFE0CA00);
  ...
  static const Color _warning_color = Colors.amber;
  static const Color _info_warning = Colors.blueAccent;
  ...
  static void _loadDarkColors() {
    ...
    mainColorSecondary = _c_main_secondary_color;
    mainColorTextField = _c_main_color_text_field;
    mainTextFieldColor = _c_main_text_field_color;
    ...
    yellow = _c_main_yellow_color;

    //Error color
    redColor = _red_color;
    infoColor = _info_warning;
    warningColor = _warning_color;
