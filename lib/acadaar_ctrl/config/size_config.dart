  ...
  static EdgeInsetsGeometry only({double top = 0,
    ...
    if (withResponsive) {
      return EdgeInsets.only(
          left: SizeConfig.getScaledSizeHeight(left),
          right: SizeConfig.getScaledSizeHeight(right),
          top: SizeConfig.getScaledSizeHeight(top),
          bottom: SizeConfig.getScaledSizeHeight(bottom));
    } else {
      return EdgeInsets.only(
